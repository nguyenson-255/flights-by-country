...
export default function Home() {
  ...
  const handelSearch = async () => {
    var code = (document.getElementById("default-search") as HTMLInputElement).value;

    if (code !== '' && code !== undefined && code != null) {
      fetchData(code);
    } else {
      window.alert("Enter a 3-character airport code")
    }
  ...
  return (
    <div className="">
      <section className="my-4 mx-16 bg-center bg-no-repeat bg-[url('https://www.gstatic.com/travel-frontend/animation/hero/flights_nc_4.svg')] bg-white bg-blend-multiply">
      <div className="py-8 px-4 mx-auto max-w-md text-center lg:py-16 lg:max-w-2xl" >
        <h1 className="mb-4 text-3xl font-extrabold tracking-tight leading-none text-gray-700 md:text-4xl lg:text-5xl dark:text-white">
          Flights by Country
        </h1>
      </div>
      </section>
      ...
      <div className="mx-auto max-w-2xl lg:max-w-2xl">
        ...
        <div className="relative">
          ...
          <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter a 3-character airport code..." required />
